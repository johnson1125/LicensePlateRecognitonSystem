...
"""
This file contains caffe2-compatible implementation of several faster_rcnn components.
"""


class Caffe2Boxes(Boxes):
    """
    Representing a list of faster_rcnn.structures.Boxes from minibatch, each box
