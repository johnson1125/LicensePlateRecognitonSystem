...
from models.faster_rcnn.detectron2.data import DatasetCatalog, MetadataCatalog
...
def register_coco_panoptic(
    ...
    The dictionaries in this registered dataset follows faster_rcnn's standard format.
...
if __name__ == "__main__":
    ...
    Usage:
        python -m faster_rcnn.data.datasets.coco_panoptic \
