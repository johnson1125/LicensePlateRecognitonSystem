...
from models.faster_rcnn.detectron2.utils.develop import create_dummy_class, create_dummy_func
...
try:
    ...
    _msg = "faster_rcnn is not compiled successfully, please build following the instructions!"
    _args = ("faster_rcnn._C", _msg)
