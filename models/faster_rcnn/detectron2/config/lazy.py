...
from models.faster_rcnn.detectron2.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from faster_rcnn.config import instantiate, LazyCall
...
_CFG_PACKAGE_NAME = "faster_rcnn._cfg_loader"
"""
