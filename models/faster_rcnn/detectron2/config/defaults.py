...
# Path (a file path, or URL like faster_rcnn://.., https://..) to a checkpoint file
...
# Cropping type. See documentation of `faster_rcnn.data.transforms.RandomCrop` for explanation.
...
# See faster_rcnn/solver/build.py for definition.
...
# and access it with:
#
# from faster_rcnn.config import global_cfg
