...
from models.faster_rcnn.detectron2.config import configurable
from models.faster_rcnn.detectron2.data.detection_utils import get_fed_loss_cls_weights
from models.faster_rcnn.detectron2.layers import ShapeSpec, batched_nms, cat, cross_entropy, nonzero_tuple
from models.faster_rcnn.detectron2.modeling.box_regression import Box2BoxTransform, _dense_box_regression_loss
from models.faster_rcnn.detectron2.structures import Boxes, Instances
        ...
        *,
        ...
        Args:
            ...
            get_fed_loss_cls_weights (Callable): a callable which takes dataset name and frequency
                ...
                faster_rcnn/data/detection_utils.py
