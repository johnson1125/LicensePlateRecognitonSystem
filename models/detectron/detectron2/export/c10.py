...
"""
This file contains caffe2-compatible implementation of several detectron components.
"""


class Caffe2Boxes(Boxes):
    """
    Representing a list of detectron.structures.Boxes from minibatch, each box
