...
def reload_lazy_config(cfg):
    ...
    """
    with tempfile.TemporaryDirectory(prefix="detectron") as d:
...
def unregister_custom_op_onnx_export(opname: str, opset_version: int, min_version: str) -> None:
    ...
    #       Remove after PyTorch 1.10+ is used by ALL detectron's CI
    try:
...
# TODO: Remove after PyTorch 1.11.1+ is used by detectron's CI
