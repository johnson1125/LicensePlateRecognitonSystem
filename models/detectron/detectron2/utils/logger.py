...
def setup_logger(
    ...
    *,
    ...
    """
    Initialize the detectron logger and set its verbosity level to "DEBUG".
    ...
    Args:
        ...
        abbrev_name (str): an abbreviation of the module, to avoid long names in logs.
            ...
            By default, will abbreviate "detectron" to "d2" and leave other
            modules unchanged.
    ...
    if abbrev_name is None:
        abbrev_name = "d2" if name == "detectron" else name
...
def _log_api_usage(identifier: str):
    """
    Internal function used to log the usage of different detectron components
    inside facebook's infra.
    """
    torch._C._log_api_usage_once("detectron." + identifier)
