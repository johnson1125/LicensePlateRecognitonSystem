...
from models.detectron.detectron2.utils.develop import create_dummy_class, create_dummy_func
...
try:
    ...
    _msg = "detectron is not compiled successfully, please build following the instructions!"
    _args = ("detectron._C", _msg)
