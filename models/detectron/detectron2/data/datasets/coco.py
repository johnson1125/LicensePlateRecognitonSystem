...
from models.detectron.detectron2.structures import Boxes, BoxMode, PolygonMasks, RotatedBoxes
...
def load_sem_seg(gt_root, image_root, gt_ext="png", image_ext="jpg"):
    ...
    Returns:
        list[dict]:
            a list of dicts in detectron standard format without instance-level
            annotation.
...
def convert_to_coco_dict(dataset_name):
    ...
    in detectron's standard format into COCO json format.
    ...
    Args:
        dataset_name (str):
            ...
            Must be registered in DatastCatalog and in detectron's standard format.
...
def convert_to_coco_json(dataset_name, output_file, allow_cached=True):
    ...
    dataset_name must be registered in DatasetCatalog and in detectron's standard format.

    Args:
        dataset_name:
            reference from the config file to the catalogs
            must be registered in DatasetCatalog and in detectron's standard format
