...
from models.detectron.detectron2.data.detection_utils import get_fed_loss_cls_weights
from models.detectron.detectron2.layers import ShapeSpec, batched_nms, cat, cross_entropy, nonzero_tuple
from models.detectron.detectron2.modeling.box_regression import Box2BoxTransform, _dense_box_regression_loss
from models.detectron.detectron2.structures import Boxes, Instances
        ...
        *,
        ...
        Args:
            ...
            get_fed_loss_cls_weights (Callable): a callable which takes dataset name and frequency
                ...
                detectron/data/detection_utils.py
