...
from models.detectron.detectron2.layers import CycleBatchNormList, ShapeSpec, batched_nms, cat, get_norm
from models.detectron.detectron2.structures import Boxes, ImageList, Instances, pairwise_iou
...
class RetinaNet(DenseDetector):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            backbone: a backbone module, must follow detectron's backbone interface
