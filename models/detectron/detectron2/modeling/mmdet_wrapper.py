...
from models.detectron.detectron2.layers import ShapeSpec
from models.detectron.detectron2.structures import BitMasks, Boxes, ImageList, Instances
...
class MMDetBackbone(Backbone):
    """
    Wrapper of mmdetection backbones to use in detectron.

    mmdet backbones produce list/tuple of tensors, while detectron backbones
    produce a dict of tensors. This class wraps the given backbone to produce
    output in detectron's convention, so it can be used in place of detectron
    backbones.
    """
...
class MMDetDetector(nn.Module):
    ...
    Input/output formats of this class follow detectron's convention, so a
    mmdetection model can be trained and evaluated in detectron.
    """
